...
install step symlinks `.agents/skills` to `.agent/skills`
...
mirror path that should resolve to the same files.
...
# [braintrust-workbench] recent context, 2026-04-26 6:48pm GMT+1
